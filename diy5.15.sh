...
# Add a feed source
# sed -i '$a src-git jiyifeng_packages https://github.com/jiyifeng/openwrt-packages' feeds.conf.default
...
git clone https://github.com/jiyifeng/openwrt-packages.git package/openwrt-packages
